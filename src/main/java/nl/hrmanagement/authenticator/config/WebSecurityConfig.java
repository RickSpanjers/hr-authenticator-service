package nl.hrmanagement.authenticator.config;

import nl.hrmanagement.authenticator.security.jwt.JwtAuthenticationEntryPoint;
import nl.hrmanagement.authenticator.security.jwt.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity security) {
        security.ignoring().antMatchers("/actuator/**", "/login/**");
    }
